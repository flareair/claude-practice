...
4. Open `module2/task01_developer-platform/Developer_Platform.ipynb`.
...
1. Install Jupyter if needed: `pip3 install notebook`
2. Open a terminal, navigate to this folder, and set your API key:
   ```bash
   export ANTHROPIC_API_KEY=your_key_here
   cd path/to/module2/task01_developer-platform/
